...
namespace ORB_SLAM2 {
    ...
    void LoopClosing::Run() {
        ...
        while (1) {
//            cout << "[info] LoopClosing::Run() while (1) begin-----------------" << endl;
            // Check if there are keyframes in the queue
            if (CheckNewKeyFrames()) {
                cout << "[info] LoopClosing CheckNewKeyFrames()--------------"
                     << count_LoopClosing_Run_CheckNewKeyFrames++ << endl;

                // Detect loop candidates and check covisibility consistency
                if (DetectLoop()) {
                    cout << "[info] DetectLoop------------------" << endl;
